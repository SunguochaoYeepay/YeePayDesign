# ds-merchant-admin implementation handoff

This archive is the source of truth for turning the design into production code. Start from `brand.json`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `brand.json`
- HTML screens detected: 0
...
For responsive web exports, treat these as a modern breakpoint system for one adaptive web experience, not three fixed screenshots. Do not split responsive web into unrelated native app screens unless the project explicitly includes native targets. Use semantic layout thresholds, fluid `clamp()` type/spacing, and container queries where component width matters more than viewport width. If responsive rules are not present in the export, add them in the target implementation before shipping.
...
- A single self-contained `brand.json` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `brand.json` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `DESIGN.md`
- `imagery/_png`
- `imagery/screenshot-20260713-112648.png`
- `imagery/screenshot-20260713-112727.png`
- `imagery/screenshot-20260713-112803.png`
- `imagery/screenshot-20260713-112827.png`
- `logos/_png`

## Coding checklist for AI tools
1. Inspect `brand.json` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
